...
api_token='c34f5b8ff6d3b09ac763a6ae50fbe2b99eedbcf1'
...
def checkyahoo():
  ...
  'signup':'',
    ...
    if KQ == None:
      print(Fore.GREEN + Style.BRIGHT + " [" + str(n_yahoo) + "] \033[1;32mEmail Die : " + yid + "@yahoo.com")
      open(yahoo_die,"a").write(yid + "@yahoo.com" + "\n")
    else:
      print(Fore.RED + Style.BRIGHT + " [" + str(n_yahoo) + "] \033[1;32mEmail Live : " + yid + "@yahoo.com")
  process_menu()
...
def checkvalid():
  ...
  for email_fb in fileEmail:
    ...
    data = {
        'lsd':'AVrpvrUhs0k',# <- TOOL CHECK SAI THÌ THAY DÒNG NÀY.
        'jazoest':'21068',# <- TOOL CHECK SAI THÌ THAY DÒNG NÀY.
        'email':email_fb,
        'did_submit':'Tìm kiếm',
}
    headers1 = {
    ...
    valid_fb = re.search("Tìm kiếm không trả về kết quả nào.",check.text)
    if valid_fb == None:
